...
export default function Features() {
  return (
    <section className="section-why tf-spacing-3 pt-0">
      <div className="tf-container">
        ...
        <div className="row">
          <div className="col-md-4">
            <div className="icons-box wow fadeInUp" data-wow-delay="0.3s">
              ...
              <div className="content">
                ...
                <p>
                  Learn from industry experts and top educators with years of 
                  teaching experience and real-world knowledge. Our instructors 
                  are carefully selected and trained to deliver the best learning experience.
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="icons-box wow fadeInUp" data-wow-delay="0.4s">
              <div className="icons has-ellipse">
                <svg
                  width={60}
                  height={61}
              ...
              <div className="content">
                ...
                <p>
                  Experience real-time learning with our interactive sessions, 
                  doubt clearing, and personalized attention from instructors. 
          ...
          <div className="col-md-4">
            <div className="icons-box wow fadeInUp" data-wow-delay="0.5s">
              <div className="icons has-ellipse">
                <svg
                  width={60}
                  height={61}
              ...
              <div className="content">
                ...
                <p>
                  Get customized learning paths based on your goals, progress, 
                  and learning style for optimal results. Track your progress 
        ...
        <div className="row mt-5">
          <div className="col-md-4">
            <div className="icons-box wow fadeInUp" data-wow-delay="0.6s">
              <div className="icons has-ellipse">
                <svg width="60" height="61" viewBox="0 0 60 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M54.4886 16.2886H5.51136C2.47282 16.2886 0 18.7483 0 21.7869V48.4942C0 51.5327 2.47282 54 5.51136 54H54.4886C57.5272 54 60 51.5327 60 48.4942V21.7869C60 18.7483 57.5272 16.2886 54.4886 16.2886Z" fill="white"/>
                  <path d="M54.4886 16.2886H5.51136C2.47282 16.2886 0 18.7483 0 21.7869V26.8647H60V21.7869C60 18.7483 57.5272 16.2886 54.4886 16.2886Z" fill="#E9DECE"/>
                  <path d="M45.3545 0H14.6455C11.5993 0 9.12354 2.47577 9.12354 5.52195V11.0438H50.8765V5.52195C50.8765 2.47577 48.4007 0 45.3545 0Z" fill="#E9DECE"/>
                  <path d="M18.2578 30.9219H12.7359V36.4438H18.2578V30.9219Z" fill="#585D69"/>
                  <path d="M26.5332 30.9219H21.0113V36.4438H26.5332V30.9219Z" fill="#585D69"/>
                  <path d="M34.8086 30.9219H29.2866V36.4438H34.8086V30.9219Z" fill="#585D69"/>
                  <path d="M43.084 30.9219H37.562V36.4438H43.084V30.9219Z" fill="#585D69"/>
                  <path d="M18.2578 39.1973H12.7359V44.7192H18.2578V39.1973Z" fill="#585D69"/>
                  <path d="M26.5332 39.1973H21.0113V44.7192H26.5332V39.1973Z" fill="#585D69"/>
                  <path d="M34.8086 39.1973H29.2866V44.7192H34.8086V39.1973Z" fill="#585D69"/>
                  <path d="M43.084 39.1973H37.562V44.7192H43.084V39.1973Z" fill="#585D69"/>
                  <path d="M54.4886 16.2886H5.51136C2.47282 16.2886 0 18.7483 0 21.7869V48.4942C0 51.5327 2.47282 54 5.51136 54H54.4886C57.5272 54 60 51.5327 60 48.4942V21.7869C60 18.7483 57.5272 16.2886 54.4886 16.2886ZM5.51136 51.2391C3.99958 51.2391 2.76087 49.9931 2.76087 48.4942V21.7869C2.76087 20.2807 3.99227 19.0447 5.51136 19.0447H54.4886C56.0004 19.0447 57.2391 20.2807 57.2391 21.7869V48.4942C57.2391 49.9931 56.0077 51.2391 54.4886 51.2391H5.51136Z" fill="#585D69"/>
                </svg>
              </div>
              <div className="content">
                <h4>
                ...
                <p>
                  Access well-structured courses designed by experts with 
                  real-world projects, quizzes, and assignments to reinforce learning.
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="icons-box wow fadeInUp" data-wow-delay="0.7s">
              <div className="icons has-ellipse">
                <svg width="60" height="61" viewBox="0 0 60 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M30 0C13.4314 0 0 13.4314 0 30C0 46.5685 13.4314 60 30 60C46.5685 60 60 46.5685 60 30C60 13.4314 46.5685 0 30 0Z" fill="#E9DECE"/>
                  <path d="M30 5C16.1929 5 5 16.1929 5 30C5 43.8071 16.1929 55 30 55C43.8071 55 55 43.8071 55 30C55 16.1929 43.8071 5 30 5Z" fill="white"/>
                  <path d="M20 20H40V40H20V20Z" fill="#585D69"/>
                  <path d="M25 25H35V35H25V25Z" fill="white"/>
                  <path d="M22 22H38V38H22V22Z" fill="#E9DECE"/>
                </svg>
              </div>
              <div className="content">
                <h4>
          ...
          <div className="col-md-4">
            <div className="icons-box wow fadeInUp" data-wow-delay="0.8s">
              <div className="icons has-ellipse">
                <svg width="60" height="61" viewBox="0 0 60 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M30 5C16.1929 5 5 16.1929 5 30C5 43.8071 16.1929 55 30 55C43.8071 55 55 43.8071 55 30C55 16.1929 43.8071 5 30 5Z" fill="#E9DECE"/>
                  <path d="M30 0C13.4314 0 0 13.4314 0 30C0 46.5685 13.4314 60 30 60C46.5685 60 60 46.5685 60 30C60 13.4314 46.5685 0 30 0Z" fill="white"/>
                  <path d="M20 20H40V40H20V20Z" fill="#585D69"/>
                  <path d="M25 25H35V35H25V25Z" fill="white"/>
                  <path d="M22 22H38V38H22V22Z" fill="#E9DECE"/>
                </svg>
              ...
              <div className="content">
                ...
                <p>
                  Get resume building, interview preparation, and job placement 
                  assistance to help you land your dream job in your chosen field.
                </p>
              </div>
            </div>
          </div>
